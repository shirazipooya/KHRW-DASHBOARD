...
wells[COLs] = wells[COLs].apply(lambda x: x.str.rstrip())
wells[COLs] = wells[COLs].apply(lambda x: x.str.lstrip())
...
aquifers[COLs] = aquifers[COLs].apply(lambda x: x.str.rstrip())
aquifers[COLs] = aquifers[COLs].apply(lambda x: x.str.lstrip())
